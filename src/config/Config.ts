...
export const AppConfig = {
    ...
    url: {
        ...
        getBiography: baseUrlApi + "/ka-jobseeker/v1/my-biography",
        postBiography: baseUrlApi + "/ka-jobseeker/v1/my-biography",
        ...
        getOrganizations: baseUrlApi + "/ka-jobseeker/v1/organizations",
        postOrganization: baseUrlApi + "/ka-jobseeker/v1/organization",
