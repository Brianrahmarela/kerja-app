...
export const AppConfig = {
  ...
  url: {
    ...
    postJobVacation: baseUrlApi + "/recruitment/v1/job-vacation",
    getJobVacationDetail: baseUrlApi + "/recruitment/v1/job-vacation",
    getJobVacation: baseUrlApi + "/recruitment/v1/search-job-vacation",
    postJobApplication: baseUrlApi + "/recruitment/v1/submit-job-application",
    getMyApplicationJob: baseUrlApi + "/recruitment/v1/my-job-application",
    getTineline: baseUrlApi + "/recruitment/v1/candidate-timeline",
    postApplicationWidthraw:
      baseUrlApi + "/recruitment/v1/widthraw-application",
    postJobBookmark: baseUrlApi + "/recruitment/v1/job-bookmark",
    getJobBookmark: baseUrlApi + "/recruitment/v1/job-bookmark",
    getSearchCompany: baseUrlApi + "/recruitment/v1/company",
    getFeaturedCompany: baseUrlApi + "/recruitment/v1/company-featured",
    getCompanyDetail: baseUrlApi + "/recruitment/v1/company-detail/",
    postCompanhyLike: baseUrlApi + "/recruitment/v1/company-like",
    postCompanhyFollow: baseUrlApi + "/recruitment/v1/company-follow",
    getCompanhyLike: baseUrlApi + "/recruitment/v1/company-like/",
    getCompanhyFollow: baseUrlApi + "/recruitment/v1/company-follow/",
    ...
    getMediaCollectionPreview:
      baseUrlApi + "/ka-socialmedia/v1/media-collection-preview",
    ...
    postNotificationAsRead:
      baseUrlApi + "/notification/v1/notification-set-read",
