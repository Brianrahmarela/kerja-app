...
import { getJobVacationDetailSlug } from "../../../../repository/JobRepo";
...
class JobDetail extends React.Component<JobDetailProps, JobDetailState> {
    ...
    getData() {
        ...
        getJobVacationDetailSlug(slug).then((res: AxiosResponse<any>) => {
    ...
    render() {
        ...
        return (
            <div className="page-job-detail">
                <Helmet>
                    <title>Lowongan kerja - {this.state.jobName + " " + organization.name}</title>
                    <meta name="description" content={this.state.jobDetail.replace(/<[^>]*>?/gm, "") + this.state.location + (this.state.jobName + " " + organization.name)} />
                </Helmet>
                <Row>
                    <Col>
                        <Breadcrumb>
                            ...
                            <Breadcrumb.Item>
                                <Link to="/public/job-search">Lowongan Pekerjaan</Link>
                            </Breadcrumb.Item>
