                            ...
                            <Form layout="vertical">
                                <Formik
                                    ...
                                    validationSchema={yup.object().shape({
                                        ...
                                        firstName: yup.string().required(`${t("register:error.firstName")}`),
                                        lastName: yup.string().required(`${t("register:error.lastName")}`),
                                        phone: yup.string().required(`${t("register:error.phone")}`),
                                        password: yup.string().required(`${t("register:error.password")}`),
                                        recaptcha: yup.string().required(`${t("register:error.recaptcha")}`),
                                    })}
                                ...
                                >
                                    {({ errors, touched, handleBlur, handleChange, handleSubmit, setFieldValue, isSubmitting }) => (
                                        <>
                                            <Form.Item
                                                label={<span className="blue-primary">{t("register:email")}</span>}
                                            ...
                                            <Form.Item label={<span className="blue-primary">{t("register:fullName")}</span>} style={{ marginBottom: 0 }}>
                                                <Row gutter={20}>
                                                    <Col xs={24} sm={24} lg={12}>
                                                        <Form.Item validateStatus={errors.firstName && touched.firstName ? "error" : ""} help={errors.firstName && touched.firstName ? errors.firstName : null}>
                                                            <Input size="large" name="firstName" onBlur={handleBlur} onChange={handleChange} placeholder={t("register:firstName")} />
                                                        </Form.Item>
                                                    </Col>
                                                    <Col xs={24} sm={24} lg={12}>
                                                        <Form.Item validateStatus={errors.lastName && touched.lastName ? "error" : ""} help={errors.lastName && touched.lastName ? errors.lastName : null}>
                                                            <Input size="large" name="lastName" onBlur={handleBlur} onChange={handleChange} placeholder={t("register:lastName")} />
                                                        </Form.Item>
                                                    </Col>
                                                </Row>
                                            </Form.Item>
                                            <Form.Item
                                                label={<span className="blue-primary">{t("register:phontNumber")}</span>}
                                                validateStatus={errors.phone && touched.phone ? "error" : ""}
                                                help={errors.phone && touched.phone ? errors.phone : null}
                                            >
                                                <Input size="large" name="phone" onBlur={handleBlur} onChange={handleChange} placeholder={t("register:phoneCode")} />
                                            </Form.Item>
                                            <Form.Item
                                                label={<span className="blue-primary">{t("register:password")}</span>}
                                            ...
                                            <Form.Item
                                                ...
                                                validateStatus={errors.recaptcha && touched.recaptcha ? "error" : ""}
                                                help={errors.recaptcha && touched.recaptcha ? errors.recaptcha : null}
                                            >
