...
const LandingImg = React.lazy(() => import('../part/LandingImg'));
                ...
                <Layout>
                    <Header style={{ position: 'fixed', zIndex: 1, width: '100%', padding: 0, margin: 0 }}>
                        <Menu theme="light" mode="horizontal" defaultSelectedKeys={['1']}>
                            <Menu.Item key="1"><Link to="/"><Avatar shape="square" size="large" icon={<img src={logoHeader} alt="logokerjaapp" />} className="logo" />
                            </Link></Menu.Item>
