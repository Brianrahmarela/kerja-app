        ...
        return (
            <div>
                    ...
                    <Row style={{ marginTop: 20 }}>
                        <Space size={24.3} direction="vertical">
                            <Col xs={17} md={10} sm={13} lg={11} span={9}>
                                <Text id="subtitlelanding">
                                    Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonummy nibh euismod tincidunt ut laoreet dolore magna aliquam erat volutpat.{" "}
                                </Text>
                            </Col>
                            <Col>
                                <div className="site-button-ghost-wrapper">
                                    <Button href="#/public/job-search" size="large" type="primary" ghost style={{ fontFamily: "Poppins", fontWeight: 400, borderRadius: 8 }} id="btnmulai">
                                        {t("landing:start")}
                                    </Button>
                                </div>
                            </Col>
                ...
                <Row className="rowiluspeoplelanding">
                    <Image style={{ padding: 0, margin: 0 }} src={IlusPeople} preview={false} id="iluspeople" height={542.84} />
                </Row>
                <Banner />
                <ProductExp />
                <ProductFeatures />
